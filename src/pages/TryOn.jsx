...
export default function TryOn() {
  ...
  const allOptions = [
    { label: 'Concept', value: '/oculos.obj' },
    { label: 'Rotem', value: '/glasses.obj' },
    { label: 'Glasses 3', value: '/glasses2.obj' }
  ];
  ...
  const drawLoop3D = () => {
    ...
    // Always render the scene, even without landmarks, to maintain visibility
    if (!overlayReady) {
